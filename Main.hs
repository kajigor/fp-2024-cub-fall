...
lovely :: [Int] -> Bool
lovely xs = short xs || case drop 2 xs of
  (14:_) -> True
  otherwise      -> False
...
ageOn planet ageInSeconds = case planet of
    "Earth"   -> ageInSeconds / earthSeconds
    "Mercury" -> ageInSeconds / (0.2408467 * earthSeconds)
    "Venus"   -> ageInSeconds / (0.61519726 * earthSeconds)
    "Mars"    -> ageInSeconds / (1.8808158 * earthSeconds)
    "Jupiter" -> ageInSeconds / (11.862615 * earthSeconds)
    "Saturn"  -> ageInSeconds / (29.447498 * earthSeconds)
    "Uranus"  -> ageInSeconds / (84.016846 * earthSeconds)
    "Neptune" -> ageInSeconds / (164.79132 * earthSeconds)
    _         -> error "Unrecognized planet. Pluto is not a planet."
    where
